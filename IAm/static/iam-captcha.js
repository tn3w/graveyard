((global, factory) => {
    ...
    class CaptchaWidget extends EventEmitter {
        ...
        _getCanvasDimensions(size) {
            const dims = {
                small: { refW: 80, refH: 120, sceneW: 120, sceneH: 120 },
                large: { refW: 160, refH: 240, sceneW: 240, sceneH: 240 },
                normal: { refW: 133, refH: 200, sceneW: 200, sceneH: 200 }
            };
            ...
            return `
                ...
                <div class="iam-content">
                    <div class="iam-reference">
                        <canvas width="${dims.refW}" height="${dims.refH}"></canvas>
        ...
        _drawReference() {
            ...
            context.drawImage(this.img, this._getRoundOffset(), 0, REF_W, 200,
        ...
        _drawScene() {
            ...
            context.drawImage(this.img, offset, 0, SCENE_W, 200,
                0, 0, canvas.width, canvas.height);
        }
